...
/**
 * Graphical User Interface for myISERN. (Currently experimental). Inspired by
...
public class MyIsernGui {
   ...
   */
  public MyIsernGui(Collaborations collaborations, Organizations organizations,
  ...
  public void createGui() {
    ...
    this.image1 = new Image(this.display, currentWorkingDirectory + "/images/image1.jpg");
    this.image2 = new Image(this.display, currentWorkingDirectory + "/images/image2.jpg");
    this.image3 = new Image(this.display, currentWorkingDirectory + "/images/image2.jpg");
    ...
    Point ri1LowerRight = new Point(ri1.location.x + ri1.size.x, ri1.location.y + ri1.size.y);
