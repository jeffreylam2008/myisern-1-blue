...
public class ObjectFactory {
    ...
    private final static QName _CollaboratingOrganization_QNAME = new QName("", "Collaborating-Organization");
    private final static QName _OutcomeType_QNAME = new QName("", "Outcome-Type");
